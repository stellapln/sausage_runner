...
int main(int argc, char** argv) {
    ...
    GLuint uLightPos_vs = glGetUniformLocation(prog.getGLId(),"uLightPos_vs");
     ...
     *********************************/
     ...
     float Shininess = 0.5;
     glm::vec4 LightPos_vs(2.0,2.0,2.0,0.0);
     glm::vec3 LightIntensity(20.0,20.0,20.0);
    ...
    const GLuint VERTEX_ATTR_TEX_COO= 2;
     ...
     FreeflyCamera cam(glm::vec3(0.0,2.0,0.0));
    ...
    while(!done) {
        ...
        glBindVertexArray(vao);
        MVMatrix = glm::translate(glm::mat4(), glm::vec3(0, 2.0, 0)); 
        MVMatrix = glm::scale(viewMatrix*MVMatrix,glm::vec3(0.5,1.0,0.5));
        ...
        glUniform3fv(uLightPos_vs,1,glm::value_ptr(LightPos_vs*viewMatrix));
        ...
        for(int i = 0;i < nbLunes;i++)
        {
			...
			MVMatrix = glm::translate(MVMatrix,glm::vec3(0.0,0.0,-i));
